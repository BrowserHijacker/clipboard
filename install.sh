#!/bin/bash
# Clipboard V 1.0
# coded by: github.com/dangerous_army/clipboard
...
printf " \e[1;92m coded by https://github.com/dangerous_army/clipboard\e[0m \n"
printf " \e[1;92m TELEGRAM: T.ME/dangerous_army\e[0m \n"
